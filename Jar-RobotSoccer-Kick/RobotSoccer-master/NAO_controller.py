...
class Controller():
    ...
    def findGoal(self):
        ...
        # x = self.sensor.getBallPosition()[0]
        # y = self.sensor.getBallPosition()[1]
        # self.motion.moveTo(x-0.20,y-0.06, 0)
        ...
        self.motion.moveTo(x - 0.10, y, 0)
        # time.sleep(0.5)
        if(random.randint(1, 2)==1):
             self.motion.LkickBall()
        else:
            self.motion.RkickBall()
